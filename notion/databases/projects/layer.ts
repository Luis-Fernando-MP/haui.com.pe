...
const ProjectAuthor = defineNestedType(() => ({
  name: 'ProjectAuthor',
  fields: {
...
const projectsFields: FieldDefs = {
  relevance: { type: 'number', required: true, default: 1 },
  ...
  notion: { type: 'string', required: false },
  logo: { type: 'string', required: false },
  summary: { type: 'string', required: false, default: '' },
  images: { type: 'list', of: ProjectImage, required: false },
  authors: { type: 'list', of: ProjectAuthor, required: false },
