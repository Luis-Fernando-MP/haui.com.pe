...
import { Achievements } from '@common/core/queries/achievementsQuery/achievement.type'
...
export const achievementCategories = Array.from(new Set(achievements.flatMap(a => a.technologies))).filter(tech => tech !== '*')
